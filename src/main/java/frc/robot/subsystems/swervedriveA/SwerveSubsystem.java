...
package frc.robot.subsystems.swervedriveA;
...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public        double      maximumSpeed = Units.feetToMeters(14.5);
    StructPublisher<Pose3d> robotPosePub = NetworkTableInstance.getDefault()
    .getStructTopic("3dSim/fakeRobot", Pose3d.struct).publish();

  /**
   * Initial Pose2d of Swerve
   */
  public final Pose2d initPose = new Pose2d();
  ...
  {
    swerveDrive = new SwerveDrive(driveCfg, controllerCfg, maximumSpeed, initPose);
  }
  ...
  public void setupPathPlanner()
  {
    ...
    AutoBuilder.configure(
        ...
        (speeds, feedforward) -> setChassisSpeeds(speeds), // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public Command sysIdDriveMotorCommand()
  {
    return SwerveDriveTest.generateSysIdCommand(
        SwerveDriveTest.setDriveSysIdRoutine(
            new Config(),
            this, swerveDrive, 5, TestingConstants.kTestWithSpinning),
        3.0, 3.0, 3.0);
  }
  ...
  public Command robotCentricDriveCommand(DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier angularRotationX)
  {
    return run(() -> {
      // Make the robot move
      swerveDrive.drive(new Translation2d(Math.pow(translationX.getAsDouble(), 1) * swerveDrive.getMaximumChassisVelocity(),
  ...
  public void periodic() {
    robotPosePub.set(new Pose3d(swerveDrive.getPose().getX(),swerveDrive.getPose().getY(),0, new Rotation3d(swerveDrive.getPose().getRotation())));
  }

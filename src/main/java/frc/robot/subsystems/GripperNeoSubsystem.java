...
public class GripperSubsystem extends SubsystemBase {
 private final SparkMax m_spark = new SparkMax(GripperConstants.DEVICE_ID, MotorType.kBrushless);
  ...
  public GripperSubsystem() {
      ...
      motorConfig.closedLoop
        ...
        .velocityFF(GripperConstants.kV)
  ...
  public Command takeAlgae() {return run(() -> sparkPID.setReference(0.5, ControlType.kMAXMotionVelocityControl));}

  public Command takeCoral() {return run(() -> sparkPID.setReference(-0.3, ControlType.kMAXMotionVelocityControl));}

  public Command throwAlgae() {return run(() -> sparkPID.setReference(-0.6, ControlType.kMAXMotionVelocityControl));}

  public Command throwCoral() {return run(() -> sparkPID.setReference(0.5, ControlType.kMAXMotionVelocityControl));}

  public Command stop() {return run(() -> sparkPID.setReference(0.0, ControlType.kMAXMotionVelocityControl));}

...
public final class Constants {
  ...
  public class Arm {
    ...
    public class SecondJoint {
      ...
      // Motion Magic
      public static final double kArmJoint2_MMCV = 200; // Cruise Velocity
      public static final double kArmJoint2_MMA = 140; // Acceleration
      public static final double kArmJoint2_MMJ = 0; // Jerk
  ...
  public static class Elevator {
    ...
    */
    ...
    public static final double kVoltageLimit = 9.0; // sakıncası olmuyorsa arttırabiliriz bence
